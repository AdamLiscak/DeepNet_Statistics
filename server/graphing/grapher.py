...
def getPointsLeft(offset,mean,step_size,sql_gt):
     while(offset<=mean):
        mycursor.execute(sql_gt,(offset,)) 
...
sql_gt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 1 and 50000 and time < %s"
sql_lt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 1 and 50000 and time > %s"
...
mycursor.execute(sql_getavg)
mean = mycursor.fetchall()[0][0]
sql_gt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 50001 and 100000 and time < %s"
sql_lt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 50001 and 100000 and time > %s"
...
mycursor.execute(sql_getavg)
mean = mycursor.fetchall()[0][0]
sql_gt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 100001 and 150000 and time < %s"
sql_lt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 100001 and 150000 and time > %s"
...
mycursor.execute(sql_getavg)
mean = mycursor.fetchall()[0][0]
sql_gt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 200001 and 250000 and time < %s"
sql_lt = "SELECT count(time)/50000 FROM `statistics` WHERE id BETWEEN 200001 and 250000 and time > %s"
getPointsLeft(0.144,mean,0.0001,sql_gt)
getPointsRight(0.25,mean,0.0001,sql_lt)
mb3val_x = x_val
mb3val_y = y_val
...
plt.plot(mb3val_y,mb3val_x, label = "MobileNetV3")
